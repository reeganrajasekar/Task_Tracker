      ...
      <View style={{zIndex:100,flex: 1,height:"100%"}}>
         ...
         >
            <View style={{height:"100%"}}>
               <ScrollView style={{backgroundColor:"#fff",borderRadius:10,borderWidth:1,borderColor:"#aaa",padding:10}}>
                  ...
                  <TextInput 
                     ...
                     numberOfLines={2}
                     maxLength={500}
                     style={{marginBottom:10,backgroundColor:"#ffffff",borderWidth:1,borderColor:"#8C68DB",borderRadius:10,fontSize:20,padding:10}}
                     onChangeText={setContent}
                     placeholder="Content *"
                     keyboardType="text"
                  />
                  <View style={{marginBottom:20,backgroundColor:"#ffffff",borderWidth:1,borderColor:"#8C68DB",borderRadius:10,padding:10,flex:1,flexDirection:"row",justifyContent:"center"}}>
                  ...
                  <View>
                     <Pressable onPress={showDatePicker} >
                        <Text style={{marginBottom:20,backgroundColor:"#ffffff",borderWidth:1,borderColor:"#8C68DB",borderRadius:10,padding:10,fontSize:20,color:"#000"}} >{(rem=="0"? <Text style={{color:"#aaa"}}>Set Remainder *</Text>:moment(rem).format("lll"))}</Text>
                     </Pressable>
                     <DateTimePickerModal
                  ...
                  <Pressable onPress={pickImage} style={{marginBottom:300}}>
                     <Text style={{marginBottom:20,backgroundColor:"#ffffff",borderWidth:1,borderColor:"#8C68DB",borderRadius:10,padding:10,fontSize:20,color:"#aaa"}} >Set Image (Optional)</Text>
               ...
               <View style={{position:"absolute",bottom:0,right:0,left:0,paddingLeft:20,paddingRight:20,backgroundColor:"#f9f9f9"}}>
         ...
         <ScrollView style={{height:"100%",marginBottom:60,backgroundColor:"#f0f0f0"}}>
