    ...
    <View style={{flex:1,justifyContent:"space-around",height:"100%",zIndex:100,padding:10}}>
        <View>
            ...
            <Text style={{fontSize:22,letterSpacing:1.2,paddingTop:15,textAlign:"justify",lineHeight:30,color:"#888"}}>
                &ensp;&ensp;Empower your workplace with the power of effective task management and generate maximum productivity. 
            </Text>
        </View>
        <View style={{marginBottom:100,alignItems:"center"}}>
            <Pressable onPress={()=>{setPage("Login")}} style={{marginBottom:30,backgroundColor:"#8C68DB",width:300,borderWidth:1,borderColor:"#ffffff",borderRadius:15}}>
                <Text style={{textAlign:"center",padding:10,fontSize:28,color:"#ffffff",fontWeight:"900"}}>Login</Text>
            </Pressable>
            <Pressable onPress={()=>{setPage("Signup")}} style={{backgroundColor:"#8C68DB",width:300,borderWidth:1,borderColor:"#ffffff",borderRadius:15}}>
